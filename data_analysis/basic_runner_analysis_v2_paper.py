...
verifier_list = ["ranking-halfspace", "trajectory_aec", "scot", "optimal_action", "state-value-critical-0.2"]
name_map = {"trajectory_aec":"ARP-pref", "scot":"SCOT", "optimal_action_allquestions":"AEC-OAP-all", "optimal_action":"ARP-bb", "ranking-halfspace":"ARP-w", "state-optimal-action-ranker":"AEC-AP","state-value-critical-0.5":"CS-0.5","state-value-critical-0.2":"CS-0.2","state-value-critical-0.1":"CS-0.1"}
exp_data_dir = os.path.join(project_path, "results")
...
for num_features in [4]:
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('./data_analysis/figs/basic_features{}_accuracy_nolegend.png'.format(num_features))
    ...
    #plt.legend(loc='best', fontsize=15)
    plt.tight_layout()
    plt.savefig('./data_analysis/figs/basic_features{}_queries_nolegend.png'.format(num_features))
...
for num_rows in [8]:
    ...
    #plt.legend(loc='best', fontsize=15)
    plt.tight_layout()
    plt.savefig('./data_analysis/figs/basic_size{}_accuracy_nolegend.png'.format(num_rows))
    ...
    #plt.legend(loc='best', fontsize=15)
    plt.tight_layout()
    plt.savefig('./data_analysis/figs/basic_size{}_queries_nolegend.png'.format(num_rows))
