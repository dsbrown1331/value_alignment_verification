...
num_rows_list = [4,8]#[4,8,16]
num_cols_list = [4,8]# [4,8,16]
num_features_list = [2,3,4,5,6,7,8]
#verifier_list = ['arp-pref',"arp-bb","scot", "arp-w","state-value-critical-0.2"]
verifier_list = ["scot", "arp-w","state-value-critical-0.2"]
